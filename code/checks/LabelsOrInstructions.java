...
public class LabelsOrInstructions extends Check {
	...
	public String[] getHTMLPass() {
		return new String[] {
				...
				"<input id=\"inputId\" aria-describedby=\"description\"><div id=\"description\">A quick description</div>", //aria described by
				"<input id=\"inputId\" aria-labelledby=\"description other\"><div id=\"description\">A quick description</div><span id=\"other\">extended</span>" //aria labelled by
		};
	}
	...
	public String[] getHTMLFail() {
		return new String[] {
				...
				"<input id=\"inputId\" aria-describedby=\"description\"><div style=\"display:none\" id=\"description\">A quick description</div>", //aria described by hidden
				"<input id=\"inputId\" aria-labelledby=\"description other\"><div id=\"description\">A quick description</div>", //aria labelled by missing
				"<input id=\"inputId\" aria-labelledby=\"description\"><div style=\"display:none\" id=\"description\">A quick description</div>", //aria labelled by hidden
